function buildSavePayload() {
    return {
        ...
        tutorialDone: state.tutorialDone, achievements: state.achievements, totalSessions: state.totalSessions
    };
}
...
function applyLoadedPackage(pkg) {
    ...
    state.tutorialDone         = pkg.tutorialDone         || false;
    state.achievements         = pkg.achievements         || [];
    state.totalSessions        = pkg.totalSessions        ?? 0;
